...
test_that("evaluate_model - output check (method accuracy)", {
  expect_true(is.atomic(evaluate_model(model = my_model, x = my_data$cues, response_category = my_data$response, decision_rule = "proportional", method = "accuracy")))
  expect_true(is.atomic(evaluate_model(model = my_model, x = my_data$cues, response_category = my_data$response, decision_rule = "criterion", method = "accuracy")))
})

test_that("evaluate_model - output check (method likelihood-up-to-constant)", {
  expect_true(is.atomic(evaluate_model(model = my_model, x = my_data$cues, response_category = my_data$response, decision_rule = "proportional", method = "likelihood-up-to-constant")))
...
test_that("evaluate_model - output check (method likelihood)", {
  expect_warning(is.atomic(evaluate_model(model = my_model, x = my_data$cues, response_category = my_data$response, decision_rule = "proportional", method = "likelihood")))
...
test_that("evaluate_model - output check (method default)", {
  expect_true(is.atomic(evaluate_model(model = my_model, x = my_data$cues, response_category = my_data$response, decision_rule = "proportional")))
