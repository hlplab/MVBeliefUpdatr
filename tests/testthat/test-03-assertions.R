...
test_that("internal predicates distinguish basic scalar types", {
  ...
  expect_false(MVBeliefUpdatr:::.is_scalar(NA))
  ...
  expect_false(MVBeliefUpdatr:::.is_scalar_numeric(NA_real_))
  expect_false(MVBeliefUpdatr:::.is_scalar_integer(NA_integer_))
  expect_false(MVBeliefUpdatr:::.is_scalar_double(NA_real_))
  expect_false(MVBeliefUpdatr:::.is_scalar_character(NA_character_))
  expect_false(MVBeliefUpdatr:::.is_scalar_factor(factor(NA)))
  expect_false(MVBeliefUpdatr:::.is_scalar_logical(NA))
  expect_false(MVBeliefUpdatr:::.is_scalar_count(NA_real_))
...
test_that(".assert_* helpers validate basic variable types", {
  ...
  expect_true(MVBeliefUpdatr:::.assert_logical_scalar(TRUE))
...
test_that("required non-NA helpers reject missing and NA values", {
  ...
  expect_error(MVBeliefUpdatr:::.assert_character_scalar(NA_character_), "Expected x to be a scalar character")
  expect_error(MVBeliefUpdatr:::.assert_numeric_scalar(NA_real_), "Expected x to be a scalar numeric")
  expect_error(MVBeliefUpdatr:::.assert_factor_scalar(factor(NA)), "Expected x to be a scalar factor")
  expect_error(MVBeliefUpdatr:::.assert_logical_scalar(NA), "Expected x to be a scalar logical")
