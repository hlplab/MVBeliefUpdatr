...
test_that("plot_parameters.ideal_adaptor_stanfit", {
  ...
  expect_no_error(plot_parameters.ideal_adaptor_stanfit(fit1))
  expect_no_error(plot_parameters.ideal_adaptor_stanfit(fit2))
  expect_no_error(plot_parameters.ideal_adaptor_stanfit(fit3))
})
...
test_that("plot_parameter_correlations.ideal_adaptor_stanfit", {
  ...
  expect_no_error(plot_parameter_correlations.ideal_adaptor_stanfit(fit1))
  expect_no_error(plot_parameter_correlations.ideal_adaptor_stanfit(fit2))
  expect_no_error(plot_parameter_correlations.ideal_adaptor_stanfit(fit3))
})
...
test_that("plot_expected_categories_contour.ideal_adaptor_stanfit", {
  expect_error(plot_expected_categories_contour2D.ideal_adaptor_stanfit(fit1))
  expect_no_error(plot_expected_categories_contour2D.ideal_adaptor_stanfit(fit2))
  expect_error(plot_expected_categories_contour2D.ideal_adaptor_stanfit(fit3))
})

test_that("plot_expected_categories_density.ideal_adaptor_stanfit", {
  expect_no_error(plot_expected_categories_density1D.ideal_adaptor_stanfit(fit1, resolution = 5, ndraws = 5))
  expect_error(plot_expected_categories_density1D.ideal_adaptor_stanfit(fit2, resolution = 5, ndraws = 5))
  expect_error(plot_expected_categories_density1D.ideal_adaptor_stanfit(fit3))
  expect_error(plot_expected_categories_density2D.ideal_adaptor_stanfit(fit1, resolution = 5, ndraws = 5))
  expect_no_error(plot_expected_categories_density2D.ideal_adaptor_stanfit(fit2, resolution = 5, ndraws = 5))
  expect_error(plot_expected_categories_density2D.ideal_adaptor_stanfit(fit3))
})
