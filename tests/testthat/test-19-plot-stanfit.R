...
test_that("plot_expected_categories.ideal_adaptor_stanfit", {
  expect_warning(plot_expected_categories(fit1, type = "contour"), "warning")
  ...
  expect_warning(plot_expected_categories(fit3, type = "contour"), "warning")
  expect_warning(plot_expected_categories(fit3, type = "density"), "warning")
})
