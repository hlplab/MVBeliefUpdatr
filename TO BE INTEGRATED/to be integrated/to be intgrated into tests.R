...
plot_ibbu_test_categorization(fit, fit.input, ndraws = 500, sort_by = "prior", group.colors = c("darkgray", "blue", "red", "black")) +
  theme_bw()
...
fit %<>%
  recover_types(d) 
plot_ibbu_test_categorization(fit, fit.input, ndraws = 500, sort_by = "prior", group.colors = c("darkgray", "blue", "red"),
