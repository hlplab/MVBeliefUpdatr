...
static constexpr std::array<const char*, 190> locations_array__ =
  ...
  " (in 'mvg_conj_sufficient_stats_lapse', line 186, column 2 to column 58)",
  " (in 'mvg_conj_sufficient_stats_lapse', line 187, column 2 to column 23)",
  ...
  " (in 'mvg_conj_sufficient_stats_lapse', line 201, column 11 to column 42)",
  " (in 'mvg_conj_sufficient_stats_lapse', line 201, column 4 to column 52)",
  " (in 'mvg_conj_sufficient_stats_lapse', line 202, column 4 to column 16)",
  " (in 'mvg_conj_sufficient_stats_lapse', line 206, column 28 to column 29)",
  " (in 'mvg_conj_sufficient_stats_lapse', line 206, column 6 to column 50)",
  " (in 'mvg_conj_sufficient_stats_lapse', line 208, column 8 to column 34)",
  " (in 'mvg_conj_sufficient_stats_lapse', line 207, column 21 to line 209, column 7)",
  " (in 'mvg_conj_sufficient_stats_lapse', line 207, column 6 to line 209, column 7)",
  " (in 'mvg_conj_sufficient_stats_lapse', line 210, column 6 to column 98)",
  " (in 'mvg_conj_sufficient_stats_lapse', line 213, column 10 to column 86)",
  " (in 'mvg_conj_sufficient_stats_lapse', line 214, column 10 to column 38)",
  " (in 'mvg_conj_sufficient_stats_lapse', line 215, column 10 to column 19)",
  " (in 'mvg_conj_sufficient_stats_lapse', line 212, column 41 to line 216, column 9)",
  " (in 'mvg_conj_sufficient_stats_lapse', line 212, column 8 to line 216, column 9)",
  " (in 'mvg_conj_sufficient_stats_lapse', line 211, column 21 to line 217, column 7)",
  " (in 'mvg_conj_sufficient_stats_lapse', line 211, column 6 to line 217, column 7)",
  " (in 'mvg_conj_sufficient_stats_lapse', line 220, column 6 to column 39)",
  " (in 'mvg_conj_sufficient_stats_lapse', line 203, column 24 to line 221, column 5)",
  " (in 'mvg_conj_sufficient_stats_lapse', line 203, column 4 to line 221, column 5)",
  " (in 'mvg_conj_sufficient_stats_lapse', line 200, column 9 to line 222, column 3)",
  " (in 'mvg_conj_sufficient_stats_lapse', line 195, column 11 to column 17)",
  " (in 'mvg_conj_sufficient_stats_lapse', line 195, column 4 to column 27)",
  " (in 'mvg_conj_sufficient_stats_lapse', line 197, column 6 to column 104)",
  " (in 'mvg_conj_sufficient_stats_lapse', line 198, column 6 to column 32)",
  " (in 'mvg_conj_sufficient_stats_lapse', line 196, column 24 to line 199, column 5)",
  " (in 'mvg_conj_sufficient_stats_lapse', line 196, column 4 to line 199, column 5)",
  " (in 'mvg_conj_sufficient_stats_lapse', line 188, column 41 to line 200, column 3)",
  " (in 'mvg_conj_sufficient_stats_lapse', line 188, column 2 to line 222, column 3)",
  " (in 'mvg_conj_sufficient_stats_lapse', line 224, column 11 to column 12)",
  " (in 'mvg_conj_sufficient_stats_lapse', line 224, column 13 to column 14)",
  " (in 'mvg_conj_sufficient_stats_lapse', line 224, column 4 to column 24)",
  " (in 'mvg_conj_sufficient_stats_lapse', line 225, column 11 to column 12)",
  " (in 'mvg_conj_sufficient_stats_lapse', line 225, column 13 to column 14)",
  " (in 'mvg_conj_sufficient_stats_lapse', line 225, column 4 to column 24)",
  " (in 'mvg_conj_sufficient_stats_lapse', line 226, column 4 to column 61)",
  " (in 'mvg_conj_sufficient_stats_lapse', line 227, column 4 to column 47)",
  " (in 'mvg_conj_sufficient_stats_lapse', line 223, column 19 to line 228, column 3)",
  " (in 'mvg_conj_sufficient_stats_lapse', line 223, column 2 to line 228, column 3)",
  ...
  " (in 'mvg_conj_sufficient_stats_lapse', line 186, column 9 to column 10)"};
...
public:
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    try {
      ...
      if (stan::math::logical_eq(split_loglik_per_observation, 0)) {
        ...
        stan::math::validate_non_negative_index("log_lik",
          "sum(to_array_1d(z_test_counts))",
          stan::math::sum(stan::math::to_array_1d(z_test_counts)));
        Eigen::Matrix<double,-1,1> log_lik =
          Eigen::Matrix<double,-1,1>::Constant(stan::math::sum(
        ...
        for (int n = 1; n <= N_test; ++n) {
          ...
          stan::math::validate_non_negative_index("z_test_counts_inc", "M", M);
          std::vector<int> z_test_counts_inc =
            std::vector<int>(M, std::numeric_limits<int>::min());
          current_statement__ = 67;
          stan::model::assign(z_test_counts_inc,
            stan::model::rvalue(z_test_counts, "z_test_counts",
              stan::model::index_uni(n)),
            "assigning variable z_test_counts_inc");
          current_statement__ = 70;
          for (int m = 1; m <= M; ++m) {
            current_statement__ = 68;
            stan::model::assign(z_test_counts_inc,
              (stan::model::rvalue(z_test_counts_inc, "z_test_counts_inc",
                 stan::model::index_uni(m)) + 1),
              "assigning variable z_test_counts_inc",
              stan::model::index_uni(m));
          }
          double multinomial_coeff = std::numeric_limits<double>::quiet_NaN();
          current_statement__ = 71;
          multinomial_coeff = (stan::math::lgamma(
                                 (stan::math::sum(
                                    stan::model::rvalue(z_test_counts,
                                      "z_test_counts",
                                      stan::model::index_uni(n))) + 1))
            - stan::math::sum(stan::math::lgamma(z_test_counts_inc)));
          ...
          log_lik_sum = (log_lik_sum + multinomial_coeff);
        }
      }
  ...
  get_param_names(std::vector<std::string>& names__, const bool
    ...
    if (emit_generated_quantities__) {
      std::vector<std::string> temp{"lapsing_probs", "log_lik_sum"};
      names__.reserve(names__.size() + temp.size());
      names__.insert(names__.end(), temp.begin(), temp.end());
    }
  }
  ...
  inline std::string get_constrained_sizedtypes() const {
    return std::string("[{\"name\":\"kappa_0\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"nu_0\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"lapse_rate_param\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(lapse_rate_param_1dim__) + ",\"element_type\":{\"name\":\"real\"}},\"block\":\"parameters\"},{\"name\":\"m_0_param\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(m_0_param_1dim__) + ",\"element_type\":{\"name\":\"vector\",\"length\":" + std::to_string(K) + "}},\"block\":\"parameters\"},{\"name\":\"m_0_tau\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(m_0_tau_1dim__) + "},\"block\":\"parameters\"},{\"name\":\"m_0_L_omega\",\"type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(m_0_L_omega_1dim__) + ",\"cols\":" + std::to_string(m_0_L_omega_2dim__) + "},\"block\":\"parameters\"},{\"name\":\"tau_0_param\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(tau_0_param_1dim__) + ",\"element_type\":{\"name\":\"vector\",\"length\":" + std::to_string(K) + "}},\"block\":\"parameters\"},{\"name\":\"L_omega_0_param\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(L_omega_0_param_1dim__) + ",\"element_type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(K) + ",\"cols\":" + std::to_string(K) + "}},\"block\":\"parameters\"},{\"name\":\"lapse_rate\",\"type\":{\"name\":\"real\"},\"block\":\"transformed_parameters\"},{\"name\":\"m_0\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(M) + ",\"element_type\":{\"name\":\"vector\",\"length\":" + std::to_string(K) + "}},\"block\":\"transformed_parameters\"},{\"name\":\"S_0\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(M) + ",\"element_type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(K) + ",\"cols\":" + std::to_string(K) + "}},\"block\":\"transformed_parameters\"},{\"name\":\"kappa_n\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(M) + ",\"element_type\":{\"name\":\"array\",\"length\":" + std::to_string(L) + ",\"element_type\":{\"name\":\"real\"}}},\"block\":\"transformed_parameters\"},{\"name\":\"nu_n\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(M) + ",\"element_type\":{\"name\":\"array\",\"length\":" + std::to_string(L) + ",\"element_type\":{\"name\":\"real\"}}},\"block\":\"transformed_parameters\"},{\"name\":\"m_n\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(M) + ",\"element_type\":{\"name\":\"array\",\"length\":" + std::to_string(L) + ",\"element_type\":{\"name\":\"vector\",\"length\":" + std::to_string(K) + "}}},\"block\":\"transformed_parameters\"},{\"name\":\"S_n\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(M) + ",\"element_type\":{\"name\":\"array\",\"length\":" + std::to_string(L) + ",\"element_type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(K) + ",\"cols\":" + std::to_string(K) + "}}},\"block\":\"transformed_parameters\"},{\"name\":\"t_scale\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(M) + ",\"element_type\":{\"name\":\"array\",\"length\":" + std::to_string(L) + ",\"element_type\":{\"name\":\"matrix\",\"rows\":" + std::to_string(K) + ",\"cols\":" + std::to_string(K) + "}}},\"block\":\"transformed_parameters\"},{\"name\":\"p_test_conj\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(N_test) + ",\"element_type\":{\"name\":\"vector\",\"length\":" + std::to_string(M) + "}},\"block\":\"transformed_parameters\"},{\"name\":\"log_p_test_conj\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(N_test) + ",\"element_type\":{\"name\":\"vector\",\"length\":" + std::to_string(M) + "}},\"block\":\"transformed_parameters\"},{\"name\":\"lapsing_probs\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(M) + "},\"block\":\"generated_quantities\"},{\"name\":\"log_lik_sum\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"}]");
  }
  inline std::string get_unconstrained_sizedtypes() const {
    return std::string("[{\"name\":\"kappa_0\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"nu_0\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"lapse_rate_param\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(lapse_rate_param_1dim__) + ",\"element_type\":{\"name\":\"real\"}},\"block\":\"parameters\"},{\"name\":\"m_0_param\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(m_0_param_1dim__) + ",\"element_type\":{\"name\":\"vector\",\"length\":" + std::to_string(K) + "}},\"block\":\"parameters\"},{\"name\":\"m_0_tau\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(m_0_tau_1dim__) + "},\"block\":\"parameters\"},{\"name\":\"m_0_L_omega\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(((m_0_L_omega_1dim__ * (m_0_L_omega_1dim__ - 1)) /2)) + "},\"block\":\"parameters\"},{\"name\":\"tau_0_param\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(tau_0_param_1dim__) + ",\"element_type\":{\"name\":\"vector\",\"length\":" + std::to_string(K) + "}},\"block\":\"parameters\"},{\"name\":\"L_omega_0_param\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(L_omega_0_param_1dim__) + ",\"element_type\":{\"name\":\"vector\",\"length\":" + std::to_string(((K * (K - 1)) /2)) + "}},\"block\":\"parameters\"},{\"name\":\"lapse_rate\",\"type\":{\"name\":\"real\"},\"block\":\"transformed_parameters\"},{\"name\":\"m_0\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(M) + ",\"element_type\":{\"name\":\"vector\",\"length\":" + std::to_string(K) + "}},\"block\":\"transformed_parameters\"},{\"name\":\"S_0\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(M) + ",\"element_type\":{\"name\":\"vector\",\"length\":" + std::to_string((K + ((K * (K - 1)) /2))) + "}},\"block\":\"transformed_parameters\"},{\"name\":\"kappa_n\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(M) + ",\"element_type\":{\"name\":\"array\",\"length\":" + std::to_string(L) + ",\"element_type\":{\"name\":\"real\"}}},\"block\":\"transformed_parameters\"},{\"name\":\"nu_n\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(M) + ",\"element_type\":{\"name\":\"array\",\"length\":" + std::to_string(L) + ",\"element_type\":{\"name\":\"real\"}}},\"block\":\"transformed_parameters\"},{\"name\":\"m_n\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(M) + ",\"element_type\":{\"name\":\"array\",\"length\":" + std::to_string(L) + ",\"element_type\":{\"name\":\"vector\",\"length\":" + std::to_string(K) + "}}},\"block\":\"transformed_parameters\"},{\"name\":\"S_n\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(M) + ",\"element_type\":{\"name\":\"array\",\"length\":" + std::to_string(L) + ",\"element_type\":{\"name\":\"vector\",\"length\":" + std::to_string((K + ((K * (K - 1)) /2))) + "}}},\"block\":\"transformed_parameters\"},{\"name\":\"t_scale\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(M) + ",\"element_type\":{\"name\":\"array\",\"length\":" + std::to_string(L) + ",\"element_type\":{\"name\":\"vector\",\"length\":" + std::to_string((K + ((K * (K - 1)) /2))) + "}}},\"block\":\"transformed_parameters\"},{\"name\":\"p_test_conj\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(N_test) + ",\"element_type\":{\"name\":\"vector\",\"length\":" + std::to_string((M -1)) + "}},\"block\":\"transformed_parameters\"},{\"name\":\"log_p_test_conj\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(N_test) + ",\"element_type\":{\"name\":\"vector\",\"length\":" + std::to_string(M) + "}},\"block\":\"transformed_parameters\"},{\"name\":\"lapsing_probs\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(M) + "},\"block\":\"generated_quantities\"},{\"name\":\"log_lik_sum\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"}]");
  }
  ...
  write_array(RNG& base_rng, Eigen::Matrix<double,-1,1>& params_r,
    ...
    const size_t num_transformed = emit_transformed_parameters * ((((((((((1
      ...
      M)));
    const size_t num_gen_quantities = emit_generated_quantities * ((M + 1));
