...
#include "stanExports_mvg_conj_sufficient_stats_lapse_full_cholesky.h"

RCPP_MODULE(stan_fit4mvg_conj_sufficient_stats_lapse_full_cholesky_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_mvg_conj_sufficient_stats_lapse_full_cholesky")
