...
public:
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    try {
      ...
      nu_0 = in__.template read_constrain_lb<local_scalar_t__, jacobian__>(0,
               lp__);
      std::vector<local_scalar_t__> m_0 =
        std::vector<local_scalar_t__>(m, DUMMY_VAR__);
      current_statement__ = 3;
      m_0 = in__.template read<std::vector<local_scalar_t__>>(m);
      std::vector<local_scalar_t__> S_0 =
        std::vector<local_scalar_t__>(m, DUMMY_VAR__);
      current_statement__ = 4;
      S_0 = in__.template read_constrain_lb<std::vector<local_scalar_t__>,
              jacobian__>(0, lp__, m);
      local_scalar_t__ lapse_rate = DUMMY_VAR__;
      current_statement__ = 5;
      lapse_rate = in__.template read_constrain_lub<local_scalar_t__,
                     jacobian__>(0, 1, lp__);
