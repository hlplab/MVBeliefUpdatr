...
#include "stanExports_NIW_ideal_adaptor.h"

RCPP_MODULE(stan_fit4NIW_ideal_adaptor_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_NIW_ideal_adaptor")
